...
urlpatterns = [
    ...
    # ?P this is an expression coming up
    # <id> is the reference of the value passed into the expression
    #\ passing in regular rexpression - d+ is digit (d is a signle digit)
